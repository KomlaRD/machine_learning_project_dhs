...
dim_missing <- dim(missing) # Assess dimensions of the dataset
dim_missing
```
...
- After droping misssing cases, number ended up as `r dim_msssing[1]` 
...
- Divide z-score values (HW72, HW70, HW71) by 100.
